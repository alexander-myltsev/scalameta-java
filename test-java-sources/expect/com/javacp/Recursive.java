...
public abstract class Recursive/*<=com.javacp.Recursive#`<init>`().*//*<=com.javacp.Recursive#*/<
        A/*<=com.javacp.Recursive#[A]*/ extends Recursive/*=>com.javacp.Recursive*/<A, B> & Serializable/*=>java.io.Serializable*/,
        B/*<=com.javacp.Recursive#[B]*/ extends Recursive/*=>com.javacp.Recursive*/.Inner/*=>com.javacp.Recursive.Inner*/<A, B>> {
    ...
    public <Anon/*<=com.javacp.Recursive#foo().[Anon]*/> ArrayList/*=>java.util.ArrayList*/<Anon> foo/*<=com.javacp.Recursive#foo().*/() {
        return new ArrayList/*=>java.util.ArrayList*/<Anon>() {
            @Override
            public boolean remove/*<=*/(Object/*=>java.lang.Object*/ o/*<=(o)*/) {
                return true;
            }
        };
    }
