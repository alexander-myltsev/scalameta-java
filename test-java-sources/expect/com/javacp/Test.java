...
public final class Test/*<=com.javacp.Test#*//*<=com.javacp.Test#`<init>`().*/<A/*<=com.javacp.Test#[A]*/ extends CharSequence & Serializable, B/*<=com.javacp.Test#[B]*/> extends ArrayList<A> implements Comparable<B>, Serializable {
    ...
    public void wildcard/*<=com.javacp.Test#wildcard(+1).*/(Collection<? extends Number> a/*<=com.javacp.Test#wildcard(+1).(a)*/, Collection<? super Number> b/*<=com.javacp.Test#wildcard(+1).(b)*/) {}
    ...
    void typeParams/*<=com.javacp.Test#typeParams().*/(ArrayList<HashMap<A, String[]>> a/*<=com.javacp.Test#typeParams().(a)*/, Hashtable<String, B> b/*<=com.javacp.Test#typeParams().(b)*/) { }
    <C/*<=com.javacp.Test#methodTypeParams().[C]*/ extends Integer> void methodTypeParams/*<=com.javacp.Test#methodTypeParams().*/(C c/*<=com.javacp.Test#methodTypeParams().(c)*/) { }

    public void overload/*<=com.javacp.Test#overload().*/(java.util.logging.Logger a/*<=com.javacp.Test#overload().(a)*/) { }
    public void overload/*<=com.javacp.Test#overload(+1).*/(Logger a/*<=com.javacp.Test#overload(+1).(a)*/) { }
    ...
    public Serializable anonymous/*<=com.javacp.Test#anonymous.*/ = new Serializable() { };
    ...
    void vararg/*<=com.javacp.Test#vararg().*/(int a/*<=com.javacp.Test#vararg().(a)*/, String... args/*<=com.javacp.Test#vararg().(args)*/) {}
    ...
    <T/*<=com.javacp.Test#m3().[T]*/ extends X & Y & Z> void m3/*<=com.javacp.Test#m3().*/() {}
}
